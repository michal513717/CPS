...
% który przepuszcza częstotliwości sygnału poniżej ustalonej częstotliwości
% granicznej (pasmo przepustowe filtru), a tłumi 
% składowe widma leżące w górnej jego części (pasmo zaporowe filtru). 
